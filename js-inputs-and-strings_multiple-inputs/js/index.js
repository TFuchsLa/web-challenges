...
switchValueButton.addEventListener("click", () => {
  const tempValue = firstSwitchValueInput.value; // Speichere den Wert des ersten Eingabefelds
  firstSwitchValueInput.value = secondSwitchValueInput.value; // Wechsle den Wert des ersten mit dem des zweiten
