...
function averageWordLength(words2) {
  ...
  let averageLength = totalLength / words2.length;
...
function uniquifyArray(words) {
  return [...new Set(words)]; // Verwende Set, um nur eindeutige Werte zu speichern und konvertiere zurück zu einem Array
}

console.log(uniquifyArray(words3)); // Ausgabe: ["crab", "poison", "contagious", "simple", "bring", "sharp", "playground", "communion"]
